...
\restrict rlEBCBHMWmFubFhp6CcjbqERPqZ9FZDq0tdDvJIXojVGOf2DIQS0x6etfyh9xpm
...
ALTER TABLE IF EXISTS ONLY public.wishlist DROP CONSTRAINT IF EXISTS wishlist_user_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.wishlist DROP CONSTRAINT IF EXISTS wishlist_product_id_products_id_fk;
ALTER TABLE IF EXISTS ONLY public.wallets DROP CONSTRAINT IF EXISTS wallets_user_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.wallet_transactions DROP CONSTRAINT IF EXISTS wallet_transactions_wallet_id_wallets_id_fk;
ALTER TABLE IF EXISTS ONLY public.wallet_transactions DROP CONSTRAINT IF EXISTS wallet_transactions_user_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.wallet_transactions DROP CONSTRAINT IF EXISTS wallet_transactions_order_id_orders_id_fk;
ALTER TABLE IF EXISTS ONLY public.user_addresses DROP CONSTRAINT IF EXISTS user_addresses_user_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.reward_points DROP CONSTRAINT IF EXISTS reward_points_user_id_users_id_fk;
...
ALTER TABLE IF EXISTS ONLY public.product_views DROP CONSTRAINT IF EXISTS product_views_user_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.product_views DROP CONSTRAINT IF EXISTS product_views_product_id_products_id_fk;
ALTER TABLE IF EXISTS ONLY public.product_views DROP CONSTRAINT IF EXISTS product_views_category_id_categories_id_fk;
ALTER TABLE IF EXISTS ONLY public.points_transactions DROP CONSTRAINT IF EXISTS points_transactions_user_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.points_transactions DROP CONSTRAINT IF EXISTS points_transactions_review_id_reviews_id_fk;
ALTER TABLE IF EXISTS ONLY public.points_transactions DROP CONSTRAINT IF EXISTS points_transactions_order_id_orders_id_fk;
ALTER TABLE IF EXISTS ONLY public.orders DROP CONSTRAINT IF EXISTS orders_user_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.orders DROP CONSTRAINT IF EXISTS orders_marketer_id_users_id_fk;
...
ALTER TABLE IF EXISTS ONLY public.marketer_profiles DROP CONSTRAINT IF EXISTS marketer_profiles_user_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.marketer_commissions DROP CONSTRAINT IF EXISTS marketer_commissions_order_id_orders_id_fk;
ALTER TABLE IF EXISTS ONLY public.marketer_commissions DROP CONSTRAINT IF EXISTS marketer_commissions_marketer_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.end_customer_contacts DROP CONSTRAINT IF EXISTS end_customer_contacts_marketer_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.coupons DROP CONSTRAINT IF EXISTS coupons_marketer_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.cart_items DROP CONSTRAINT IF EXISTS cart_items_user_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.cart_items DROP CONSTRAINT IF EXISTS cart_items_product_id_products_id_fk;
DROP INDEX IF EXISTS public.idx_visitor_sessions_session;
DROP INDEX IF EXISTS public.idx_visitor_sessions_last_seen;
DROP INDEX IF EXISTS public.idx_phone_verifications_phone;
...
ALTER TABLE IF EXISTS ONLY public.visitor_sessions DROP CONSTRAINT IF EXISTS visitor_sessions_session_id_key;
...
ALTER TABLE IF EXISTS ONLY public.reward_points DROP CONSTRAINT IF EXISTS reward_points_user_id_unique;
ALTER TABLE IF EXISTS ONLY public.reward_points DROP CONSTRAINT IF EXISTS reward_points_pkey;
...
ALTER TABLE IF EXISTS ONLY public.pending_sync_orders DROP CONSTRAINT IF EXISTS pending_sync_orders_pkey;
ALTER TABLE IF EXISTS ONLY public.orders DROP CONSTRAINT IF EXISTS orders_pkey;
ALTER TABLE IF EXISTS ONLY public.order_items DROP CONSTRAINT IF EXISTS order_items_pkey;
ALTER TABLE IF EXISTS ONLY public.offers DROP CONSTRAINT IF EXISTS offers_pkey;
ALTER TABLE IF EXISTS ONLY public.notifications DROP CONSTRAINT IF EXISTS notifications_pkey;
ALTER TABLE IF EXISTS ONLY public.navigation_settings DROP CONSTRAINT IF EXISTS navigation_settings_pkey;
ALTER TABLE IF EXISTS ONLY public.marketer_profiles DROP CONSTRAINT IF EXISTS marketer_profiles_user_id_unique;
ALTER TABLE IF EXISTS ONLY public.marketer_profiles DROP CONSTRAINT IF EXISTS marketer_profiles_pkey;
ALTER TABLE IF EXISTS ONLY public.marketer_commissions DROP CONSTRAINT IF EXISTS marketer_commissions_pkey;
ALTER TABLE IF EXISTS ONLY public.logo_settings DROP CONSTRAINT IF EXISTS logo_settings_pkey;
ALTER TABLE IF EXISTS ONLY public.home_sections DROP CONSTRAINT IF EXISTS home_sections_pkey;
ALTER TABLE IF EXISTS ONLY public.home_page_settings DROP CONSTRAINT IF EXISTS home_page_settings_pkey;
ALTER TABLE IF EXISTS ONLY public.end_customer_contacts DROP CONSTRAINT IF EXISTS end_customer_contacts_pkey;
ALTER TABLE IF EXISTS ONLY public.display_settings DROP CONSTRAINT IF EXISTS display_settings_pkey;
ALTER TABLE IF EXISTS ONLY public.digital_wallets DROP CONSTRAINT IF EXISTS digital_wallets_pkey;
...
ALTER TABLE IF EXISTS public.wishlist ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.reward_points ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.points_transactions ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.phone_verifications ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.pending_sync_orders ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.navigation_settings ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.marketer_profiles ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.marketer_commissions ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.logo_settings ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.home_sections ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.home_page_settings ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.end_customer_contacts ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.display_settings ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.digital_wallets ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS public.reward_points_id_seq;
DROP TABLE IF EXISTS public.reward_points;
...
DROP SEQUENCE IF EXISTS public.points_transactions_id_seq;
...
DROP SEQUENCE IF EXISTS public.pending_sync_orders_id_seq;
DROP TABLE IF EXISTS public.pending_sync_orders;
...
DROP SEQUENCE IF EXISTS public.navigation_settings_id_seq;
DROP TABLE IF EXISTS public.navigation_settings;
DROP SEQUENCE IF EXISTS public.marketer_profiles_id_seq;
DROP TABLE IF EXISTS public.marketer_profiles;
DROP SEQUENCE IF EXISTS public.marketer_commissions_id_seq;
DROP TABLE IF EXISTS public.marketer_commissions;
DROP SEQUENCE IF EXISTS public.logo_settings_id_seq;
DROP TABLE IF EXISTS public.logo_settings;
DROP SEQUENCE IF EXISTS public.home_sections_id_seq;
DROP TABLE IF EXISTS public.home_sections;
DROP SEQUENCE IF EXISTS public.home_page_settings_id_seq;
DROP TABLE IF EXISTS public.home_page_settings;
DROP SEQUENCE IF EXISTS public.end_customer_contacts_id_seq;
DROP TABLE IF EXISTS public.end_customer_contacts;
DROP SEQUENCE IF EXISTS public.display_settings_id_seq;
DROP TABLE IF EXISTS public.display_settings;
DROP SEQUENCE IF EXISTS public.digital_wallets_id_seq;
DROP TABLE IF EXISTS public.digital_wallets;
...
2	+967774997589	273787	0	f	2026-04-06 12:03:13.474	2026-04-06 11:58:13.486469
\.
...
SELECT pg_catalog.setval('public.visitor_sessions_id_seq', 11, true);
...
\unrestrict rlEBCBHMWmFubFhp6CcjbqERPqZ9FZDq0tdDvJIXojVGOf2DIQS0x6etfyh9xpm
