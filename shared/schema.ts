...
export const products = pgTable("products", {
  ...
  studioPreviewPrice: numeric("studio_preview_price").default("0").notNull(),   // رسوم معاينة الاستوديو على مستوى المنتج (ر.ي)
  // ── حقول الخصم ──────────────────────────────────────────────────────────────
...
export const displaySettings = pgTable("display_settings", {
  ...
  showFinancialSection: boolean("show_financial_section").default(true),           // إظهار بطاقات "حسابي المالي" (محفظة/نقاط/ائتمان/مفضلة)
